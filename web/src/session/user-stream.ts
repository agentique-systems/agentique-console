 ...
 *    speaker's persisted message.appended; turn.settled retires ALL
...
>({
  ...
  retirement: (event): Retirement | undefined => {
    ...
    if (event.type === "user_session.message.appended") {
