...
CREATE TABLE `runs` (
	...
	CONSTRAINT "runs_operator_pause" CHECK("runs"."operator_pause" IS NULL OR "runs"."operator_pause" IN ('soft', 'hard')),
	CONSTRAINT "runs_operator_pause_status" CHECK("runs"."operator_pause" IS NULL OR "runs"."status" IN ('waiting', 'verifying', 'awaiting_signoff')),
	CONSTRAINT "runs_operator_wait_is_pause" CHECK(("runs"."wait_reason" IS 'operator') = ("runs"."status" = 'waiting' AND "runs"."operator_pause" IS NOT NULL)),
