...
const valid = { ok: true as const, result: { status: "completed" as const, artifactIds: [], tasks: [], evidence: [], summary: "ok", openItems: [], blocker: null, runOutcome: null, routeSelection: null, evaluation: null, finalReport: null } };
